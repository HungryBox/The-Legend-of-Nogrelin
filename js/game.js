...
(function() {
  var Actor, Enemy, Grid, GridCodes, GridSpace, Ogre, Player, actors, canvas, ctx, enemyActionAvailable, floorImage, floorReady, grid, hero, keysDown, main, ogre, ogreImage, ogreReady, playerActionAvailable, playerImage, playerReady, render, requestAnimationFrame, update, w, wallImage, wallReady,
